    ...
    <div class="index-aside-inner menulist">
      <div v-for="item in menuList" :key="item.roleName" v-if="role==item.roleName" class="menulist-item">
        <div class="menulistImg" v-if="true && 1 == 2">
          <el-image :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}' v-if="'http://codegen.caihongy.cn/20211112/aec8d7d4ffff47d5acc934e0c3636b8e.png'" src="http://codegen.caihongy.cn/20211112/aec8d7d4ffff47d5acc934e0c3636b8e.png" fit="cover" />
        </div>
      ...
      this.$nextTick(()=>{
        document.querySelectorAll('.menulist .el-menu-item').forEach(el=>{
          el.addEventListener("mouseenter", e => {
            e.stopPropagation()
            el.style.backgroundColor = "rgba(0, 0, 0, 0.26)"
          })
          el.addEventListener("mouseleave", e => {
            e.stopPropagation()
            // el.style.backgroundColor = "linear-gradient(90deg, rgba(204,80,17,1) 0%, rgba(204,80,17,1) 60%, rgba(250,212,0,1) 60%, rgba(250,212,0,1) 100%)"
    ...
    .menulistImg {
      ...
      .el-image {
		...
		&>.el-menu-item {
			...
			border-style: solid;
			border-color: rgba(250, 212, 0, 1) !important;
		...
		& /deep/ .el-menu.el-menu--inline {
			...
			.el-menu-item {
                ...
                &.is-active {
                    ...
                    background-color: rgba(255, 69, 0, 1) !important;
                    box-shadow: 0 0 6px rgba(30, 144, 255, 0);
                    text-align: center;
                }
